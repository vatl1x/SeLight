        ...
        <div>
            ...
            <div className="ctrl-grid">
                ...
                <div className="card ctrl-card">
                    ...
                    <button
                        className="btn btn-primary ctrl-apply"
                        onClick={applyLight}
                    >
                        Применить команду
                    </button>
                ...
                <div className="card ctrl-card">
                    ...
                    <div className="alarm-desc">
                        При взведённой сигнализации любое срабатывание датчика
                        движения создаёт уведомление об охранном событии.
                    </div>
            ...
            {msg && (
                <div
                    className={`ctrl-msg ${msgType === "err" ? "ctrl-msg-err" : ""}`}
                >
                    {msg}
                </div>
            )}
